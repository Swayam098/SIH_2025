...
const features = [
  ...
  },
  {
    ...
    description: "AI-powered arrival predictions based on traffic, weather, and historical data.",
    color: "text-secondary", 
    shadowColor: "hover:shadow-glow-green"
  },
  {
    icon: Shield,
    title: "Safe Journey",
    description: "Emergency alerts, safety notifications, and 24/7 customer support.",
    color: "text-primary",
    shadowColor: "hover:shadow-glow-blue"
  },
  {
    ...
    description: "Push notifications for delays, route changes, and service disruptions.",
    color: "text-secondary",
    shadowColor: "hover:shadow-glow-green"
  }
];
