    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-30 text-center max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Button size="lg" className="btn-hero px-8 py-4 text-lg font-semibold rounded-full" onClick={() => navigate("/buses")}> 
            <Bus className="w-5 h-5 mr-2" />
            Track Buses
          </Button>
          <Button size="lg" variant="outline" className="btn-secondary-hero px-8 py-4 text-lg font-semibold rounded-full" onClick={() => navigate("/sms-sim")}> 
